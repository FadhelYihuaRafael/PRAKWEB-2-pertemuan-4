<?php 
require_once 'claass_mahasiswa.php';

$daftar_mahasiswa = [
    new Mahasiswa("0110224216", "Jonathan", 2024, "Teknik Informatika", 3.75),
    new Mahasiswa("0110224217", "Ucup", 2024, "Sistem Informasi", 2.75),
    new Mahasiswa("0110224218", "Sapir", 2024, "Bisnis Digital", 1.75),
    new Mahasiswa("0110224219", "Fadel", 2024, "Apoteker", 3.25),
];
